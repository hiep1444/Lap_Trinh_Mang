...
//1571020100
    ...
    ArrayList<File> fileItems = new ArrayList<>();
...
//1571020100
                ...
                while ((message = reader.readLine()) != null) {
                    ...
                    switch (data[2]) {
                        ...
                        case "Chat":
                            ...
                            break;
                        case "Upload_File":{
                            String fileName = data[1].split("\\#")[0];
                            String typeFile = data[1].split("\\#")[1];
                            System.out.println("Start download file");
                            new Thread(new FileDownloader("src/files_server/" + fileName, "", 8181, fileItems)).start();
                            files.add(fileName + "#" + typeFile);
                            String data_files = "reload:";
                            for(String s : files){
                                data_files += s + ",";
                            }
                            data_files = data_files.substring(0, data_files.length() - 1) + ":reloadFiles";
                            tellEveryone(data_files);
                            break;
                        }
                        default:
    ...
    public void sendImage(byte[] imageData, String imageName) {
        try {
            FileOutputStream fos = new FileOutputStream("./server_images/" + imageName);
            fos.write(imageData);
            fos.close();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    // Phương thức gửi file từ client lên server
    ...
    private void initComponents() {
        ...
        dataStored.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
...
//1571020100
        ...
        public void run() {
            ...
            users = new ArrayList();
            new Thread(
                    new RunnableServerFile(null, false, 8282, fileItems))
                    .start();
